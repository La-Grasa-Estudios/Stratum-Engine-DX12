...
namespace Render {
	...
	public:
		...
		DLLEXPORT Frustum(glm::mat4 m);

		// http://iquilezles.org/www/articles/frustumcorrect/frustumcorrect.htm
		DLLEXPORT bool IsBoxVisible(const glm::vec3& minp, const glm::vec3& maxp) const;
		DLLEXPORT bool SphereInFrustum(glm::vec3& position, float radius);
